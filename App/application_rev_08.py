...
class MainFrame(wx.Frame):
    def __init__(self):
        ...
        def create_search_box(parent, label, search_fields, size=(300, -1)):
            ...
            # Tạo dropdown menu cho search_box
            search_menu = wx.Menu()
            ...
            return sizer, search_box

        # Thêm vùng search dropdown phía trên grid sử dụng hàm vừa tạo
        search_fields = [
        ...
        search_sizer, self.search_box = create_search_box(
            content_panel, label="System:", search_fields=search_fields, size=(300, -1)
        )
